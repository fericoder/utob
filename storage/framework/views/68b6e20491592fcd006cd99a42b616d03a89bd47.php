                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($doctor->fullName); ?></td>
                                <td><?php echo e($doctor->title); ?></td>
                                <td><?php echo e(jdate($doctor->created_at)); ?></td>
                                
                                
                                
                                <td>
                                    <a href=""
                                       data-id="<?php echo e($doctor->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill button"
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(url('dashboard/doctor/delete')); ?>",
                        data: {id:id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'لیست پزشک ها'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/doctors/index.blade.php ENDPATH**/ ?>