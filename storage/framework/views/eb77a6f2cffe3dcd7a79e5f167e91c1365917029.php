                    ...
                    <div class="m-portlet__head-caption">
						...
						<i class="la la-gear"></i>
                            ...
                            <h3 class="m-portlet__head-text">
                                ویرایش درمان: <?php echo e($treatment->title); ?>

                            </h3>
                        </div>
                    </div>
                    <a target="_blank" href="/treaments/<?php echo e($treatment->id); ?>"><button style="margin-top: 20px;" type="submit" class="btn btn-sm btn-primary">مشاهده درمان</button></a>
                </div>
                <!--begin::Form-->
                <form action="<?php echo e(route('treatment.update', $treatment->id)); ?>" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="name" class="form-control m-input"
                                       value="<?php echo e($treatment->name); ?>">
                            </div>
                        </div>
                        ...
                        <div class="m-form__group m-form__group--last form-group row">
                            <div class="col-12 form-group m-form__group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea style="direction: rtl; width: 90%!important;" id="body" name="body" rows="18"><?php echo e($treatment->body); ?></textarea>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'ویرایش درمان'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/treatments/edit.blade.php ENDPATH**/ ?>