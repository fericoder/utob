                                                                            ...
                                                                            <div class="col-md-4 col-sm-6 col-xs-12 post-84 slzexploore_hotel">
                                                                                <div class="hotels-layout">
                                                                                    <div class="image-wrapper">
                                                                                        <a class="link"
                                                                                           href="<?php echo e(route('hospital' , $hospital->id)); ?>"><img
                                                                                                    width="800" height="540"
                                                                                                    src="<?php echo e($hospital->image); ?>"
                                                                                        ...
                                                                                        <div class="title-wrapper">
                                                                                            <a href="<?php echo e(route('hospital' , $hospital->id)); ?>"
                                                                                               class="title"><?php echo e($hospital->name); ?></a>
                                                                                            <div class="stars stars<?php echo e($hospital->stars); ?>"><?php echo e($hospital->stars); ?>
                                                                                        ...
                                                                                        <div class="content">
                                                                                            <div class="title">
                                                                                                <div class="price"><sup>قیمت از شبی</sup><span
                                                                                                            class="number utob-byekan"><?php echo e($hospital->price); ?> دلار </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div style="margin-top: 20px!important;" class="group-btn-tours"><a href="<?php echo e(route('hospital' , $hospital->id)); ?>" class="left-btn">مشاهده جزییات</a></div>
                                                                                        </div>
                                                                                        <ul style="display: none" class="list-info list-unstyle">
                                                                                            <li class="view"><a
                                                                                                        href="<?php echo e(route('hospital' , $hospital->id)); ?>"
                                                                                                        class="link"><i
                                                                                            ...
                                                                                            <li class="comment"><a
                                                                                                        href="<?php echo e(route('hospital' , 1)); ?>#comments"
                                                                                                        class="link"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/hospital/index.blade.php ENDPATH**/ ?>