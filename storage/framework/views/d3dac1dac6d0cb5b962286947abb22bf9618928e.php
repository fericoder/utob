                    ...
                    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                <a href="<?php echo e(route('experience.create')); ?>"
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($experience->fullName); ?></td>
                                <td><?php echo e(jdate($experience->created_at)); ?></td>
                                
                                
                                
                                <td>
                                    <a href=""
                                       data-id="<?php echo e($experience->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill button"
                                       title="View "> <i style="color: darkred" class="fa fa-times"></i> </a>

                                    <a href="<?php echo e(route('hospital.edit', $experience->id )); ?>"
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(url('dashboard/experience/delete')); ?>",
                        data: {id:id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'لیست تجربه ها'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/experiences/index.blade.php ENDPATH**/ ?>