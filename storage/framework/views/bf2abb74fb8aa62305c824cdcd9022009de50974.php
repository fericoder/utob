    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form action="<?php echo e(route('treatment.store')); ?>" method="post" enctype="multipart/form-data"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'افزودن درمان'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/treatments/create.blade.php ENDPATH**/ ?>