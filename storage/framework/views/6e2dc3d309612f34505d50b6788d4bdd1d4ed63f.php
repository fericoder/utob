                                                                            ...
                                                                            <div class="col-md-4 col-sm-6 col-xs-12 post-84 slzexploore_hotel">
                                                                                <div class="hotels-layout">
                                                                                    <div class="image-wrapper">
                                                                                        <a class="link"
                                                                                           href="<?php echo e(route('experience' , $experience->id)); ?>"><img
                                                                                                    width="800" height="540"
                                                                                                    src="<?php echo e($experience->image); ?>"
                                                                                        ...
                                                                                        <div class="title-wrapper">
                                                                                            <a href="<?php echo e(route('experience' , $experience->id)); ?>"
                                                                                               class="title"><?php echo e($experience->fullName); ?></a>
                                                                                            <img style="width: 50px" src="<?php echo e($experience->flag); ?>" alt="">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="content-wrapper ">
                                                                                        <div class="content">
                                                                                            <div class="title">
                                                                                                <div class="price">تجربه <?php echo e($experience->fullName); ?> از <?php echo e($experience->country); ?>  </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div style="margin-top: 20px!important;" class="group-btn-tours"><a href="<?php echo e(route('experience' , $experience->id)); ?>" class="left-btn">مشاهده جزییات</a></div>
                                                                                        </div>
                                                                                        <ul style="display: none" class="list-info list-unstyle">
                                                                                            <li class="view"><a
                                                                                                        href="<?php echo e(route('experience' , $experience->id)); ?>"
                                                                                                        class="link"><i
                                                                                            ...
                                                                                            <li class="comment"><a
                                                                                                        href="<?php echo e(route('experience' , 1)); ?>#comments"
                                                                                                        class="link"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/exprience/index.blade.php ENDPATH**/ ?>