                                                                            ...
                                                                            <div class="col-md-4 col-sm-6 col-xs-12 post-84 slzexploore_hotel">
                                                                                <div class="hotels-layout">
                                                                                    <div class="image-wrapper">
                                                                                        <a class="link"
                                                                                           href="<?php echo e(route('hotel' , $hotel->id)); ?>"><img
                                                                                        ...
                                                                                        <div class="title-wrapper">
                                                                                            <a href="<?php echo e(route('hotel' , $hotel->id)); ?>"
                                                                                               class="title"><?php echo e($hotel->name); ?></a>
                                                                                            <div class="stars stars<?php echo e($hotel->stars); ?>"><?php echo e($hotel->stars); ?>
                                                                                        ...
                                                                                        <div class="content">
                                                                                            <div class="title">
                                                                                                <div class="price"><sup>قیمت از شبی</sup><span
                                                                                                            class="number utob-byekan"><?php echo e($hotel->price); ?> دلار </span>
                                                                                                </div>
                                                                                            </div>
                                                                                                <div style="margin-top: 20px!important;" class="group-btn-tours"><a href="<?php echo e(route('hotel' , $hotel->id)); ?>" class="left-btn">مشاهده جزییات</a></div>
                                                                                        </div>
                                                                                        <ul style="display: none" class="list-info list-unstyle">
                                                                                            <li class="view"><a
                                                                                                        href="<?php echo e(route('hotel' , $hotel->id)); ?>"
                                                                                                        class="link"><i
                                                                                            ...
                                                                                            <li class="comment"><a
                                                                                                        href="<?php echo e(route('hotel' , 1)); ?>#comments"
                                                                                                        class="link"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/hotel/index.blade.php ENDPATH**/ ?>