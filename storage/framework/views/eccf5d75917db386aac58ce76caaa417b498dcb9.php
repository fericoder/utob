<?php $__env->startSection('content'); ?>
    ...
    <div id="wrapper-content">
        ...
        <div class="main-content">
            <!-- Page Title -->
            <section style="background-image: url(wp-content/uploads/2016/07/espinas.jpg);!important;"
                     class=" page-title">
                <div class="container">
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="" class="link">هتل اسپیناس پالاس</a></li>
                            </ol>
                            <div class="clearfix"></div>
                            <h2 style="margin-bottom: 35px;" class="captions">
                                اسپیناس پالاس</h2>
                            <div class="price"><span class="text"></span><span class="number utob-byekan">200</span><sup
                                        class="unit">تومان</sup></div>
            ...
            <div class="hotel-view-main padding-top padding-bottom entry-content">
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div class="slz-shortcode item-list-style06 item-list-20322406125e273ad44b5af wrapper-journey "
                                                        ...
                                                        <div class="item feature-item"><i
                                                            ...
                                                            <div class="text">وای فای رایگان</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="timeline-custom-col image-col hotels-layout">
                                                    <div class="content-wrapper">
                                                        <div class="content">
                                                            <div class="title">
                                                                <div class="price"><span class="number utob-byekan">300,000</span><sup>تومان</sup>
                                                                </div>
                                                            </div>
                ...
                <div class="map-block">
                    <div class="map-info">
                        ...
                        <p class="address  utob-byekan"><i class="fa fa-map-marker"></i> آدرس: سعادت آباد، میدان بهرود،
                            مجتمع تجاری-اداری پرواز، طبقه دوم اداری، واحد 1
                        </p>
                        <p class="phone utob-byekan"><i class="fa fa-phone"></i> 22094188-26742050
                        </p>
                        <p class="mail"><a href="mailto:domain@expooler.com"> <i class="fa fa-envelope"></i>
                                https://1stquest.com/hotel
                            </a></p>
                        <div class="footer-block"><a class="btn btn-open-map">مشاهده نقشه</a></div>
                    </div>
                    <div id="googleMap"
                         data-img-url="http://wp.swlabs.co/exploore/wp-content/plugins/slzexploore-core/assets/images/marker.png"
                         data-json="{&quot;address&quot;:&quot;111 Pirachai Village, Bangkok, Thailand&quot;,&quot;lat&quot;:&quot;13.7497788&quot;,&quot;lng&quot;:&quot;100.79330809999999&quot;}"></div>
                </div>
                <div class="container">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\A\Desktop\laravel\utob\resources\views/hotel-view.blade.php ENDPATH**/ ?>