                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="index.html" class="link">راه های ارتباطی</a></li>
                            </ol>
                                                                                    ...
                                                                                    <div class="info-list">
                                                                                        <ul class="list-unstyled">
                                                                                            <li class="main-list"><i
                                                                                                        class="icons fa fa-map-marker"></i><span
                                                                                                        class="link"> میدان بهرود، مجتمع اداری پرواز، طبقه دوم، واحد 1</span>
                                                                                            </li>
                                                                                            <li class="main-list"><i
                                                                ...
                                                                <div class="container">
                                                                    <div class="wrapper-contact-form">
                                                                        <div data-wow-delay="0.5s"
                                                                             class="contact-wrapper wow fadeInLeft">
                                                        ...
                                                        <div class="slz-shortcode contact-15710631765e1e7affc22ff ">
                                                            <div class="map-block" data-id="15710631765e1e7affc22ff">
                                                                <div class="map-info">
                                                                    ...
                                                                    <p class="address  utob-byekan"><i
                                                                                class="fa fa-map-marker"></i> آدرس:
                                                                        سعادت آباد، میدان بهرود، مجتمع تجاری-اداری
                                                                        پرواز، طبقه دوم اداری، واحد 1
                                                                    </p>
                                                                    <p class="phone utob-byekan"><i
                                                                                class="fa fa-phone"></i>
                                                                        22094188-26742050
                                                                    </p>
                                                                    <p class="mail"><a
                                                                                href="mailto:domain@expooler.com"> <i
                                                                                    class="fa fa-envelope"></i>
                                                                            https://1stquest.com/hotel
                                                                        </a></p>
                                                                    <div class="footer-block"><a
                                                                                class="btn btn-open-map">مشاهده نقشه</a>
                                                                    </div>
                                                                </div>
                                                                <div id="googleMap"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/contact.blade.php ENDPATH**/ ?>