<div id="m_aside_left" class="m-grid__item m-aside-left  m-aside-left--skin-dark ">
    ...
    <div
        ...
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
            ...
            <li class="m-menu__item  m-menu__item--submenu  <?php echo e(request()->is('dashboard/category*') ? 'm-menu__item--open' : ''); ?>  "
                aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="javascript:;" class="m-menu__link m-menu__toggle"><i
                ...
                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                    <ul class="m-menu__subnav">
                        ...
                        <li class="m-menu__item <?php echo e(request()->is('dashboard/category') ? 'm-menu__item--active' : ''); ?> "
                            aria-haspopup="true"><a
                                    href="<?php echo e(route('category.index')); ?>"
                                    class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">لیست بیمارستان ها</span></a></li>
                        <li class="m-menu__item <?php echo e(request()->is('dashboard/category/create') ? 'm-menu__item--active' : ''); ?>"
                            aria-haspopup="true"><a
...
<!-- END: Left Aside --><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/layouts/partials/menu.blade.php ENDPATH**/ ?>