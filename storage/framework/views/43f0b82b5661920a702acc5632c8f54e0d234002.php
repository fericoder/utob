    ...
    <div class="lm-item lm-item-2">
        ...
        <div class="lm-item-body">
            <div class="lm-item-desc">
                <p>جراحی زیبایی - جراحی زیبایی - جراحی زیبایی </p>
            </div>
            <ul class="lm-item-list">
                <li>هتل ۳ ستاره<i class="icon-ok"></i></li>
                <li>سرویس فرودگاه<i class="icon-ok"></i></li>
                <li>حمل  ونقل درون شهری<i class="icon-ok"></i></li>
                <li>مترجم<i class="icon-ok"></i></li>
                <li>اینترنت و سیم کارت<i class="icon-ok"></i></li>
                <li>آزمایش و عکس برداری<i class="icon-ok"></i></li>
                <br><span class="mt-2">سایر خدمات: گردشگری، پرستاری، پولی و بانکی</span><br>
            </ul>
        ...
        <div class="lm-item-body">
            ...
            <div class="lm-item-link"><a href="#">
                    <svg width="152" height="52" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="1" y="1" width="150" height="50" rx="25" fill="#fff" stroke="url(#lm-gr-1)"
                              stroke-width="1"></rect>
        ...
        <div class="lm-item-body">
            ...
            <div class="lm-item-link"><a href="#">
                    <svg width="152" height="52" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="1" y="1" width="150" height="50" rx="25" fill="#fff" stroke="url(#lm-gr)"
                              stroke-width="1"></rect>
                        <text x="70%" y="65%" fill="url(&quot;#lm-gr&quot;)">انتخاب</text>
                    </svg>
                </a></div>
...
</script><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/layouts/partials/packages.blade.php ENDPATH**/ ?>