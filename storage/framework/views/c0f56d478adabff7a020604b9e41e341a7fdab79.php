<?php $__env->startSection('content'); ?>
    ...
    <div id="wrapper-content">
        ...
        <div class="main-content">
            <!-- Page Title -->
            <section style="background-image: url(<?php echo e($hospital->image); ?>);!important;"
                     class=" page-title">
                <div class="container">
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="<?php echo e(route('hospitals')); ?>" class="link">هتل ها</a></li>
                                <li><a href="<?php echo e(route('hospital', $hospital->id )); ?>" class="link"><?php echo e($hospital->name); ?></a></li>
                            </ol>
                                ...
                                <div class="timeline-container">
                                    <div class="timeline timeline-hotel-view">
                                        <div class="timeline-block">
                                            <div class="timeline-title"><span> <?php echo e($hospital->name); ?></span></div>
                    ...
                    <div class="container">
                        <div class="slz-shortcode special-offer margin-top70">
                            ...
                            <div class="special-offer-list">
                                ...
                                <?php $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hospitall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="special-offer-layout post-185 slzexploore_hotel">
                                        <div style="height: 160px!important;" class="image-wrapper">
                                            <a class="link" href="<?php echo e(route('hospital', $hospitall->id )); ?>"><img style="height: 160px!important;" width="342"  src="<?php echo e($hospitall->image); ?>" class="img-responsive" alt=""/></a>
                                            <div class="title-wrapper"><a href="<?php echo e(route('hospital', $hospitall->id )); ?>" class="title"><?php echo e($hospitall->name); ?></a><i class="icons flaticon-circle"></i>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/hospital/show.blade.php ENDPATH**/ ?>