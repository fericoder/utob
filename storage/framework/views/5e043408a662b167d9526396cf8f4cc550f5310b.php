                    ...
                    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                <a href="<?php echo e(route('treatment.create')); ?>"
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <?php $__currentLoopData = $treatments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(jdate($treatment->created_at)); ?></td>
                                
                                
                                
                                <td>
                                    <a href=""
                                       data-id="<?php echo e($treatment->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill button"
                                       title="View "> <i style="color: darkred" class="fa fa-times"></i> </a>

                                    <a href="<?php echo e(route('treatment.edit', $treatment->id )); ?>"
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(url('dashboard/treatment/delete')); ?>",
                        data: {id:id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'لیست درمان ها'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/treatments/index.blade.php ENDPATH**/ ?>