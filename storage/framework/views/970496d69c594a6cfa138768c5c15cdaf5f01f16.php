<?php $__env->startSection('content'); ?>
                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="/blogs" class="link">مقالات</a></li>

                            </ol>
                            <div class="clearfix"></div>
                            <h2 class="captions" style="margin-bottom:35px;">مقالات پزشکی</h2>
                        </div>
                    </div>
                </div>
            </section>
  ...
  <div class="container">
    ...
    <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="slz-shortcode blog  blog-16986474155e2ed7f600baa">
    ...
    <div class="col-md-6 blog-post post-249 post type-post status-publish format-video has-post-thumbnail hentry category-adventure category-discover category-explore tag-adventure tag-explore tag-traveler post_format-post-format-video">
      <div class="blog-image"><a href="<?php echo e(route('blog', 1)); ?>" class="link"><img width="750" height="350" src="/utob-content/uploads/2016/05/jk.jpg" class="img-responsive" alt="about-us-1" /></a></div>
    ...
    <a href="<?php echo e(route('blog', 1)); ?>" class=" heading" >جراحی بینی &#8211; مصرف دارو</a>
    <h5 class="meta-info"><span>اضافه شده توسط: </span> <a href="<?php echo e(route('blog', 1)); ?>" class=""><span>خانم شیرازی </span></a> <span class="sep">/</span><span class="view-count fa-custom utob-byekan">6400</span><span class="comment-count fa-custom"><a href=""><span class="utob-byekan">5</span></a></span></h5>
    <div class="preview"><p>
    ...
    <a href="<?php echo e(route('blog', 1)); ?>" class="btn btn-gray btn-fit btn-capitalize">بیشتر بخوانید</a>
    </div>
    </div>
    </div>
    ...
    <div class="blog-image"><a href="<?php echo e(route('blog', 1)); ?>" class="link"><img width="750" height="350" src="/utob-content/uploads/2016/05/mashroob.jpg" class="img-responsive" alt="about-us-1" /></a></div>
    <div class="blog-content">
    <div class="col-xs-2">
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="<?php echo e(route('blog', 1)); ?>" class=" heading" >رژیم غذایی قبل از جراحی بینی</a>
    ...
    <div class="blog-image"><a href="<?php echo e(route('blog', 1)); ?>" class="link"><img width="750" height="350" src="/utob-content/uploads/2016/05/sigar.jpg" class="img-responsive" alt="Luxury-Private-Jet" /></a></div>
    <div class="blog-content">
    <div class="col-xs-2">
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="<?php echo e(route('blog', 1)); ?>" class=" heading" >مصرف دخانیات قبل و بعد جراحی</a>
    ...
    <div class="blog-image"><a href="<?php echo e(route('blog', 1)); ?>" class="link"><img width="750" height="350" src="/utob-content/uploads/2016/05/mooo.jpg" class="img-responsive" alt="hotel-6" /></a></div>
    <div class="blog-content">
    <div class="col-xs-2">
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="<?php echo e(route('blog', 1)); ?>" class=" heading" >روش های کاشت مو (روش FUT)
</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/app/blog/index.blade.php ENDPATH**/ ?>