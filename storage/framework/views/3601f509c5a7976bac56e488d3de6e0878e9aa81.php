                ...
                <div class="m-portlet__body">
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <tr>
                            ...
                            <th title="Field #2" data-field="Owner">نام</th>
                            <th title="Field #3" data-field="Contact">نام خانوادگی</th>
                            <th title="Field #4" data-field="CarMake">آدرس ایمیل</th>
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(jdate($user->lastLogin)); ?></td>
                                <td><?php echo e(jdate($user->LastAction)); ?></td>
                                <td><?php echo e(jdate($user->created_at)); ?></td>
                                <td>
                                    <a href=""
                                       data-id="<?php echo e($user->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill button"
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(url('dashboard/user/delete')); ?>",
                        data: {id:id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('.dashboard.layouts.master',  ['title' => 'لیست کاربران'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alirahmani/Projects/utob/resources/views/dashboard/users/index.blade.php ENDPATH**/ ?>