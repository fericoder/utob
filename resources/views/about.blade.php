                                                ...
                                                <div class="vc_column-inner vc_custom_1463110533434">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div class="wpb_text_column wpb_content_element  vc_custom_1463035461905">
                                                            <div class="wpb_wrapper">
                                                                <p>
                                                                    درحال‌حاضر بعضی از بیمارستان‌ها و پزشکان به‌صورت مجزا فعالیت‌هایی در جذب بیماران خارجی انجام می‌دهند، اما رقابت بالای بین‌المللی و پیچیدگی‌های بازاریابی در خارج از کشور سبب می‌شود این فعالیت‌های جزیره‌ای و تنها چندان موفقیت‌آمیز نباشد. درنتیجه لزوم یک سایت تخصصی برای معرفی حرفه‌ای خدمات‌دهنده‌های ایرانی در سطح جهان انکارناپذیر است. ما در آریامدتور می‌کوشیم با تمرکز و استفاده از نیروهای متخصص بازاریابی دیجیتال، پتانسیل بالای ارائه‌ی خدمات پزشکی و زیبایی ایران را به علاقه‌مندان مدیکال‌توریسم نشان دهیم و همچنین با کمک آژانس‌های گردشگری، تسهیلاتی برای سفر آسان و باصرفه به ایران را مهیا کنیم.
                                                                </p>
                                                            </div>
                                                        </div>
