@extends('.dashboard.layouts.master',  ['title' => 'ویرایش هتل'])
        ...
        <div class="col-xl-12">
            <div class="m-portlet">
                <div class="m-portlet__head">
                    ...
                    <a target="_blank" href="/treaments/{{ $hotel->id }}"><button style="margin-top: 20px;" type="submit" class="btn btn-sm btn-primary">مشاهده هتل</button></a>
                </div>
                <!--begin::Form-->
                <form action="{{ route('hotel.update', $hotel->id)  }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">عنوان هتل:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="m-form__group m-form__group--last form-group row">
                            <div class="col-12 form-group m-form__group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea style="direction: rtl; width: 90%!important;" id="body" name="body" rows="18">{{ $hotel->body }}</textarea>
                                </div>
                            </div>
                        </div>
