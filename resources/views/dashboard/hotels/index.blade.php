@extends('.dashboard.layouts.master',  ['title' => 'لیست هتل ها'])
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        @foreach ($hotels as $hotel)
                            <tr>
                                ...
                                <td>
                                    <a href=""
                                       data-id="{{$hotel->id}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill button"
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        type: "post",
                        url: "{{url('dashboard/hotel/delete')}}",
                        data: {id:id},
