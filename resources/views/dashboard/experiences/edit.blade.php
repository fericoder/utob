@extends('.dashboard.layouts.master',  ['title' => 'ویرایش تجربه مشتری'])
                    ...
                    <div class="m-portlet__head-caption">
						...
						<i class="la la-gear"></i>
                            ...
                            <h3 class="m-portlet__head-text">
                                ویرایش تجربه مشتری: {{ $experience->title }}
                            </h3>
                        </div>
                    </div>
                    <a target="_blank" href="/treaments/{{ $experience->id }}"><button style="margin-top: 20px;" type="submit" class="btn btn-sm btn-primary">مشاهده تجربه مشتری</button></a>
                </div>
                <!--begin::Form-->
                <form action="{{ route('experience.update', $experience->id)  }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">عنوان تجربه مشتری:</label>
                            <div class="col-lg-6">
                        ...
                        <!--begin::Form-->
                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">تصویر تجربه مشتری</label>
                            <div class="col-lg-6">
                        ...
                        <div class="m-form__group m-form__group--last form-group row">
                            <div class="col-12 form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">متن تجربه مشتری</label>
                                <div class="col-lg-10">
                                    <textarea style="direction: rtl; width: 90%!important;" id="body" name="body" rows="18">{{ $experience->body }}</textarea>
                                </div>
                            </div>
                        </div>
