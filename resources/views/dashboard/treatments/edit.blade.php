@extends('.dashboard.layouts.master',  ['title' => 'ویرایش درمان'])
                    ...
                    <div class="m-portlet__head-caption">
						...
						<i class="la la-gear"></i>
                            ...
                            <h3 class="m-portlet__head-text">
                                ویرایش درمان: {{ $treatment->title }}
                            </h3>
                        </div>
                    </div>
                    <a target="_blank" href="/treaments/{{ $treatment->id }}"><button style="margin-top: 20px;" type="submit" class="btn btn-sm btn-primary">مشاهده درمان</button></a>
                </div>
                <!--begin::Form-->
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-form__group m-form__group--last form-group row">
                            <div class="col-12 form-group m-form__group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea style="direction: rtl; width: 90%!important;" id="body" name="body" rows="18">{{ $treatment->body }}</textarea>
                                </div>
                            </div>
                        </div>
