...
@section('content')
    ...
    <div id="wrapper-content">
        ...
        <div class="main-content">
            <!-- Page Title -->
            <section style="background-image: url({{ $hospital->image }});!important;"
                     class=" page-title">
                <div class="container">
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="{{ route('hospitals') }}" class="link">هتل ها</a></li>
                                <li><a href="{{ route('hospital', $hospital->id ) }}" class="link">{{ $hospital->name }}</a></li>
                            </ol>
                                ...
                                <div class="timeline-container">
                                    <div class="timeline timeline-hotel-view">
                                        <div class="timeline-block">
                                            <div class="timeline-title"><span> {{ $hospital->name }}</span></div>
                    ...
                    <div class="container">
                        <div class="slz-shortcode special-offer margin-top70">
                            ...
                            <div class="special-offer-list">
                                ...
                                @foreach ($hospitals as $hospitall)
                                    <div class="special-offer-layout post-185 slzexploore_hotel">
                                        <div style="height: 160px!important;" class="image-wrapper">
                                            <a class="link" href="{{ route('hospital', $hospitall->id ) }}"><img style="height: 160px!important;" width="342"  src="{{ $hospitall->image }}" class="img-responsive" alt=""/></a>
                                            <div class="title-wrapper"><a href="{{ route('hospital', $hospitall->id ) }}" class="title">{{ $hospitall->name }}</a><i class="icons flaticon-circle"></i>
                                            </div>
                                        </div>
                                    </div>
