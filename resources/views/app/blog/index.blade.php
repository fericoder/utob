...
@section('content')
  ...
  <div class="container">
    ...
    <a href="{{ route('blog', 1) }}" class=" heading" >جراحی بینی &#8211; مصرف دارو</a>
    <h5 class="meta-info"><span>اضافه شده توسط: </span> <a href="{{ route('blog', 1) }}" class=""><span>خانم شیرازی </span></a> <span class="sep">/</span><span class="view-count fa-custom utob-byekan">6400</span><span class="comment-count fa-custom"><a href=""><span class="utob-byekan">5</span></a></span></h5>
    <div class="preview"><p>
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="{{ route('blog', 1) }}" class=" heading" >رژیم غذایی قبل از جراحی بینی</a>
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="{{ route('blog', 1) }}" class=" heading" >مصرف دخانیات قبل و بعد جراحی</a>
    ...
    <div class="col-xs-10 content-wrapper">
    <a href="{{ route('blog', 1) }}" class=" heading" >روش های کاشت مو (روش FUT)
</a>
