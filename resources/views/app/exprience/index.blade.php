                                                                            ...
                                                                            <div class="col-md-4 col-sm-6 col-xs-12 post-84 slzexploore_hotel">
                                                                                <div class="hotels-layout">
                                                                                    <div class="image-wrapper">
                                                                                        <a class="link"
                                                                                           href="{{ route('experience' , $experience->id) }}"><img
                                                                                        ...
                                                                                        <div class="title-wrapper">
                                                                                            <a href="{{ route('experience' , $experience->id) }}"
                                                                                               class="title">{{ $experience->fullName }}</a>
                                                                                            <img style="width: 50px" src="{{ $experience->flag }}" alt="">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="content-wrapper ">
                                                                                        <div class="content">
                                                                                            <div class="title">
                                                                                                <div class="price">تجربه {{ $experience->fullName }} از {{ $experience->country }}  </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div style="margin-top: 20px!important;" class="group-btn-tours"><a href="{{ route('experience' , $experience->id) }}" class="left-btn">مشاهده جزییات</a></div>
                                                                                        </div>
                                                                                        <ul style="display: none" class="list-info list-unstyle">
                                                                                            <li class="view"><a
                                                                                                        href="{{ route('experience' , $experience->id) }}"
                                                                                                        class="link"><i
                                                                                            ...
                                                                                            <li class="comment"><a
                                                                                                        href="{{ route('experience' , 1) }}#comments"
                                                                                                        class="link"><i
