                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="/experiences" class="link">تجربه فردی</a></li>
                            </ol>
                ...
                <div class="blog-author margin-bottom margin-top">
                    <div class="media blog-author-content">
                        ...
                        <div class="media-right">
                            <div class="author">
                                <a class="name" href="">از همه چیز راضی
                                    بودم...</a>
                            </div>
                            <div class="position">هدی جمال از کشور عمان</div>
                            <div class="des"><p>پزشکان ایرانی در دنیا بهترین هستند. من از نتیجه عملم بسیار راضی ام و
                                    عالی شده به نظرم. دوستانم هم بعد از عمل من میخوان بیان پیش دکتر........ عمل کنن.
                                    برخورد پرسنل بسیار خوب بود و با اینکه من به زبان فارسی و انگلیسی آشنایی نداشتم در
                                    برقراری ارتباط به زبان عربی هیچ مشکلی نداشتم. همه اینا هم بخاطر مترجم همراهمون بود
                                    که تمام روز رو با ما بود.
                                    مدتی که در تهران هستم رو به خوبی استفاده کنم و فرهنگ و تاریخ ایرانی رو ببینم. مرسی
                                    از شما برای این تجربه خوب
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-8 col-md-offset-2">
                                                    <div class="video-wrapper"><h2 class="title">عمل بینی/عمان
                                                        </h2>
                                                        <div class="text"> در این بخش فیلم کوتاهی از اقامت هدی جمال در
                                                            ایران می بینید و نحوه درمان و عملکرد یوتاب مد.
                                                        </div>
                ...
                <div class="container">
                    <div class="col-md-12 blog-post post-249 post type-post status-publish format-video has-post-thumbnail hentry category-adventure category-discover category-explore tag-adventure tag-explore tag-traveler post_format-post-format-video">
                        ...
                        <div class="blog-content">
                            <div class="col-xs-2">
                                <div class="row">
                                    <div class="date"><h1 class="day utob-byekan">21</h1>
                                        <div class="month">خرداد</div>
                                        <div class="year utob-byekan">1396</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-10 content-wrapper">
                                <a href=""
                                   class=" heading"></a>
                                <h5 class="meta-info"><span>اضافه شده توسط:</span> <a
                                            href=""
                                            class=""><span>نانسی ارس</span></a> <span class="sep">/</span><span
                                            class="view-count fa-custom utob-byekan">6392</span><span
                                            class="comment-count fa-custom"><a
                                                href=""><span
                                                    class="utob-byekan">45</span></a></span></h5>
                                <div class="preview"><p>مادرم سکته کرده بود دکترا گفتن سه تا از رگای قلبش مسدود شده باید
                                        عمل قلب باز بشه، مادرم به شدت میترسید تا اینکه تحقیق کردیم و متوجه شدیم پزشک های
                                        ایران بسیار ماهر هستند و...</p>
                                </div>
                                <a href=""
                                   class="btn btn-gray btn-fit btn-capitalize">بیشتر بخوانید</a>
                            </div>
                        </div>
                    </div>
                </div>
