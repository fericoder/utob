...
@section('content')
    ...
    <div id="wrapper-content">
        ...
        <div class="main-content">
            <!-- Page Title -->
            <section style="background-image: url({{ $hotel->image }});!important;"
                     class=" page-title">
                <div class="container">
                                    ...
                                    <div class="timeline-container">
                                        <div class="timeline timeline-hotel-view">
                                            <div class="timeline-block">
                                                <div class="timeline-title"><span> {{ $hotel->name }}</span></div>
                                ...
                                @foreach ($hotels as $hotell)
                                    <div class="special-offer-layout post-185 slzexploore_hotel">
                                        <div style="height: 160px!important;" class="image-wrapper">
                                            <a class="link" href="{{ route('hotel', $hotell->id ) }}"><img style="height: 160px!important;" width="342"  src="{{ $hotell->image }}" class="img-responsive" alt=""/></a>
                                            <div class="title-wrapper"><a href="{{ route('hotel', $hotell->id ) }}" class="title">{{ $hotell->name }}</a><i class="icons flaticon-circle"></i>
                                            </div>
                                        </div>
                                    </div>
