...
@section('content')
    ...
    <div id="wrapper-content">
        ...
        <div class="main-content">
            <!-- Page Title -->
            <section style="background-image: url(/utob-content/uploads/2016/07/espinas.jpg);!important;"
                     class=" page-title">
                <div class="container">
                                                    ...
                                                    <div class="image-hotel-view-block">
                                                        <div class="slider-for">
                                                            <div class="item"><img width="600" height="270"
                                                                                   src="/utob-content/uploads/2018/10/1.jpeg"
                                                                                   class="" alt="img-2"
                                                                                   />
                                                            </div>
                                                            <div class="item"><img width="600" height="270"
                                                                                   src="/utob-content/uploads/2018/10/2.jpeg"
                                                                                   class=""
                                                                                   alt="wall-interior-design-ideas-12"/>
                                                            </div>
                                                            <div class="item"><img width="600" height="270"
                                                                                   src="/utob-content/uploads/2018/10/3.jpeg"
                                                                                   class=""
